...
export interface Android {
  ...
  package?: string;
  /**
   * Unique application ID that identifies your app on the device and in Google Play Store. [Learn more](https://developer.android.com/studio/build/application-id)
   */
